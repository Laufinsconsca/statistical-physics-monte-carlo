...
if __name__ == '__main__':
    ...
    # выбор устройства для расчёта корреляционной функции
    # (расчёт на GPU поддерживается только видеокартами компании Nvidia)
    # также для расчёта необходимо в переменных средах добавить путь к cl.exe в переменную Path,
    ...
    M_relax = 499900  # количество отсеиваемых состояний (по умолчанию 1000)
    #  ----------------------------- <параметры газа> ------------------------------------------------------------------
    ...
    output_play_out_progress_to_console = False  # позволяет отслеживать процент выполнения программы однако
    ...
    output_pair_corr_func_progress_to_console = False  # позволяет отслеживать процент выполнения программы однако
    # снижает производительность (при N <= 1000 примерно на 10%)
